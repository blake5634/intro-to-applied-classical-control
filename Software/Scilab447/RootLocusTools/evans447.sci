...
//
//  modified by Blake Hannaford for cleaner output 
function evans447(n,d,kmax)
    // Seuil maxi et mini (relatifs) de discretisation en espace
    // Copyright INRIA

    smax=0.0006;smin=smax/3;
    nptmax=4000 //nbre maxi de pt de discretisation en k
...
//            printf( "evans447() pas NOT correct\n")
            ix=1:md
            ord1=[]
            for ky=1:md
                yy=r(ky)
    ...
    //  BH: uncomment next two lines to replace caption box
