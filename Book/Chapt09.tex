...
\end{verbatim}
Followed immediatly by the code of Listing \ref{lstInitialAIPrompt}.
...
\begin{verbatim}
 Thank you.   Could you revise that to add lines to the plot which
...
red-dashed settling time line is barely visible)


\paragraph{Prompt 3}
Now we ask it to fix the issues identified above:
\begin{verbatim}
...
It's very cool that Claude.ai moved the PID controller poles to
