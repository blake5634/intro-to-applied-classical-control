...
\begin{tabular}{|l|l|l|l|p{2.5in}|} \hline
 Name             &  Physical Realization        &   Symbol    &  Equation              & Notes   \\ \hline
  Inertia         &  Flywheel                    &   $J$ \raisebox{-\totalheight}{\includegraphics[width=0.5in]{figs03/00740aa.png}}    &  $\tau(t) = J\ddot{\theta}$    &  \\ \hline
  Stiffness       &  Coil  Spring                &   $K$ \raisebox{-\totalheight}{\includegraphics[width=1.0in]{figs03/00740ba.png}}   &  $\tau(t) = K{\theta}$         & $\tau$ is same on both sides.  Assume zero rest length \\ \hline
  Damping         & Fan, rotary damper, friction &   $B$ \raisebox{-\totalheight}{\includegraphics[width=1.0in]{figs03/00740ca.png}}   &  $\tau(t) = B\dot{\theta}$     & This is a linear model for friction.     \\ \hline
...
Consider the rack and pinion shown in Figure \ref{basicrotarylinear}.  Assume the gear can rotate about it's fixed axis and the rack is free to slide back and forth in the $x$ direction.  The force applied by the rack to the gear must be
\[
F = \tau/r
\]
